...
class TensorCompletion(object):
    ...
    def init_dataset(self, path):
        self.x_true_img1 = mt.read_image_abs_path(path)
        #self.x_true_img = smooth_img(self.x_true_img1, 5)
        
        self.x_true_data = np.array(self.x_true_img.get_data()).astype('float32')
        ...
        #normalize after mask init
        #self.x_true_img = clean_img(self.x_true_img, detrend=False, standardize=True,t_r=2)
