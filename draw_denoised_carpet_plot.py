...
import math
import fmri_plot_denoise_plot as fm
...
def frmi_plot(in_file, low_rank_file, sparse_file, gauss_file, spike_folder, file_path, legend=False, tr=None, stddev=False, tsnr=False, img_slice=None):
    ...
    if tr and tsnr and stddev:
        fm_plot = fm.fMRIPlotDenoisePlot(
                in_file,
                low_rank_file,
                sparse_file,
                gauss_file,
...
if __name__ == "__main__":
    ...
    in_file = "/work/scratch/tensor_completion/4D/noise/corrupted_subjects/artifacts/normal/x_true.nii"
    fname, ext = op.splitext(op.basename(in_file))
    folder = "/work/project/cmsc655/figures/"
    spike_folder = "/work/project/cmsc655/subject_artifacts"
    
    fig_id = "frmi_summary_plot_signal_slice_denoised_richian_25db" + fname
